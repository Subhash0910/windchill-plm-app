  ...
  return (
    <div className="dashboard-page">
      ...
      <main className="dashboard-main">
        ...
        {/* KPI Cards — row 2: ECR breakdown */}
        <div className="kpi-grid kpi-grid--ecr" style={{ marginBottom: 24 }}>
          ...
          <div>
            ...
            <div className="dash-section">
              ...
              {loading ? (
                ...
                <div className="empty-state">
                  <span>📝</span>
                  <p>No ECRs yet in this context</p>
                  <button className="btn-primary" onClick={() => navigate('/plm/changes')}>Create First ECR</button>
                </div>
              ) : (
                <div className="lifecycle-bars">
            ...
            {!loading && inReviewEcrs > 0 && (
              <div className="dash-section dash-section--ecr-alert">
                ...
                <p className="alert-text">
                  <strong>{inReviewEcrs}</strong> ECR{inReviewEcrs !== 1 ? 's are' : ' is'} currently IN REVIEW and awaiting a decision.
                  {criticalEcrs > 0 && <> &nbsp;<strong style={{ color: '#991b1b' }}>({criticalEcrs} Critical)</strong></>}
                </p>
                <button className="btn-purple btn-sm" onClick={() => navigate('/plm/changes')}>
                  Review ECRs &rarr;
                </button>
              </div>
            )}
            ...
            <div className="dash-section">
              ...
              {loading ? (
                ...
                <div className="empty-state-sm">
                  No ECRs yet &mdash;{' '}
                  <button className="link-btn" onClick={() => navigate('/plm/changes')}>create one</button>
                </div>
              ) : (
                <div className="ecr-recent-list">
                    ...
                    return (
                      <div key={ecr.id} className="ecr-recent-row" onClick={() => navigate(`/plm/changes/ecr/${ecr.id}`)}>
                        ...
                        <div className="ecr-recent-pills">
                          <span className="ecr-recent-pill" style={{ background: pc.bg, color: pc.text }}>
                            {ecr.priority}
                          </span>
                          <span className="ecr-recent-pill" style={{ background: sc.bg, color: sc.text }}>
                            {sc.label}
                          </span>
                        </div>
                      </div>
                  ...
                  <button className="link-btn view-all" onClick={() => navigate('/plm/changes')}>
                    View all ECRs &rarr;
                  </button>
                </div>
              )}
